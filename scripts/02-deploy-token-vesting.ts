const {
  ...
  async function deployTokenVesting() {
    ...
    const timelockAddress = "0x0000000000000000000000000000000002eFeb4C";
    const mockERC20Address = "0x0000000000000000000000000000000002efEb23";
    ...
    const startTimestamp = 1673524327;
    const duration = 3600;
    ...
    // https://hashscan.io/testnet/contract/0.0.49281154 - without SafeERC20Transfer 
    // https://hashscan.io/testnet/contract/0.0.49322122 - bytes implementation
  }
  
module.exports = deployTokenVesting;
  //void deployTokenVesting();
